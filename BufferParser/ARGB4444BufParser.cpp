...
QString ARGB4444BufParser::parse(const uint8_t *pSrc, uint8_t *pDst, int width, int height) {
...
void ARGB4444BufParser::invParse(const uint8_t *pSrc, uint8_t *&rpDst, int width, int height) {
    uint16_t pixelVal = 0;
    uint16_t r,g,b,a;
